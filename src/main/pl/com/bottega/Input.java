...
public class Input {
	...
	public String getCondition() {
		...
		while(true){
			...
			if(condition.equals("wyczynowa") || condition.equals("œwietna") ||
					condition.equals("dobra") || condition.equals("ponadprzeciêtna") ||
					condition.equals("przeciêtna") || condition.equals("s³aba") ||
					condition.equals("z³a")){
			return condition;
			} else {
				System.out.println("Wpisz poprawnie kondycjê(wyczynowa/œwietna/dobra/ponadprzeciêtna/przeciêtna/s³aba/z³a)");
			}
		}
	}
}
